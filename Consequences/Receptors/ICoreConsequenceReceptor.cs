...
public interface ICoreConsequenceReceptor<TResult> where TResult : struct
{
    ...
    TResult ComputeComponents<THazard>(THazard hazard) where THazard : IHazard;
    ...
    void Compute<THazard>(THazard hazard, out TResult result) where THazard : IHazard;
    ...
    double Compute<THazard>(THazard hazard) where THazard : IHazard;
